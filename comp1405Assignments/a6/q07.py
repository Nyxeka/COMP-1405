...
class MyGame(object):
    ...
    def run(self):
        ...
        dir = {"up":[0,-movement_increment], "down":[0,movement_increment], "left":[-movement_increment,0], "right":[movement_increment,0]}
        ...
        while running:
            ...
            # time to draw a new frame
                ...
                image_pos_x += dir[current_direction][0]
                image_pos_y += dir[current_direction][1]
                ...
                if image_pos_y > max_down:
                    image_pos_y = max_down
                    current_direction = "right"
