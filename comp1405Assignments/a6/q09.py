...
class MyGame(object):
    ...
    def draw(self):
        ...
        myfont = pygame.font.Font("CALLIGRA.TTF", 48)
        my_name = myfont.render("Nicholas J. Hylands", 1, (0,255,255))
        self.screen.blit(my_name, (self.width/2-my_name.get_width()/2,0))
